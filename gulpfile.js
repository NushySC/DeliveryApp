...
const html = () => gulp.src(paths.html.src).pipe(plumber()).pipe(gulp.dest(paths.html.dest));
...
const build = gulp.series(clean, gulp.parallel(styles, vendors, scripts, images, favicon), cacheBust);
